...
namespace ShawInterviewExercise.API.Controllers
{
    ...
    public class ShowService
    {
        ...
        private List<Show> AddShowtoList(Show showAdd,List<Show> shows)
        {
             ...
             try
            {
                ...
                shows.Add(
                    new Show()
                    {
                        Id = Showcount+1,
                        Name = showAdd.Name,
                        Description = showAdd.Description
                    });
        ...
        public bool AddShow(Show showAdd)
        {
            try
            {
                this.Shows = AddShowtoList(showAdd, this.Shows);
                return true;
